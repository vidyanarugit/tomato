...
<div><th><h5><input name="restname" type="text"/></h5></th></div>
	<tr>
		<!-- th width="80">ID</th-->
...
<tr>
		<td>Your Name</td>
		<td><input id="name" name="uName" type="text" value=""/></td> 
	</tr>
	<tr>
		<td>look and feel</td>
		<td><input id="name" name="ambRating" type="text" value=""/></td> 
	</tr>
	<tr>
		<td>Food</td>
		<td><input id="name" name="foodRating" type="text" value=""/></td> 
	</tr>
	<tr>
		<td>Service</td>
		<td><input id="name" name="serviceRating" type="text" value=""/></td> 
	</tr>
	<tr>
		<td>Review</td>
		<td><input id="name" name="review" type="text" value=""/></td> 
	</tr>
